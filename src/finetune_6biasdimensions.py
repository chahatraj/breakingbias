...
wandb.init(project=f"contact-theory-chat", name="6biasdimensions-13b-en")
...
train_dataset, eval_dataset = prepare_datasets(
    "../data/finetune/finetune_6biasdimensions/train.csv", 
    "../data/finetune/finetune_6biasdimensions/valid.csv"
)
...
model.push_to_hub("chahatraj/contact-base-6biasdimensions-13b-en")
