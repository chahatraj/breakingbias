...
SAVE_PATH = f"../finetune_eval/after_finetune/ft_3keyprinciples_dataset_responses_{LLAMA_SIZE}B.csv"
...
# Load the LoRa model
peft_model_id = "chahatraj/contact-base-3keyprinciples-13b-en"
