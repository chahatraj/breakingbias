...
wandb.init(project=f"contact-theory-chat", name="alldata-13b-en")
...
train_dataset, eval_dataset = prepare_datasets(
    "../data/finetune/finetune_alldata/train.csv", 
    "../data/finetune/finetune_alldata/valid.csv"
)
...
model.push_to_hub("chahatraj/contact-base-alldata-13b-en")
